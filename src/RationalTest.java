...
public class RationalTest {
    ...
    @Test
    public void test_gcd_1_m3() {
        assertEquals(1, Rational.gcd(1,-3));
    }

    @Test
    public void test_gcd_m3_1() {
        assertEquals(1, Rational.gcd(-3, 1));
    }

    @Test
    public void test_gcd_m12_m88() {
        assertEquals(4, Rational.gcd(-12,-88));
    }
    ...
    @Test
    public void test_lcm_of_1250_45() {
        assertEquals(Rational.lcm(1250, 45), 11250);
    }

    @Test
    public void test_lcm_of_0_5() {
        assertEquals(Rational.lcm(0, 5), 0);
    }

    @Test
    public void test_lcm_of_12_15() {
        assertEquals(Rational.lcm(12, 15), 60);
    }

    @Test
    public void test_lcm_of_45_1250() {
        assertEquals(Rational.lcm(45, 1250), 11250);
    }
    ...
    @Test
    public void test_difference_of_r_13_4_and_r_3_7() {
        Rational r = Rational.difference(r_13_4,r_3_7);
        assertEquals("79/28",r.toString());
    }

    @Test
    public void test_difference_of_r_m3_1_and_r_1_m3() {
        Rational r_m3_1 = new Rational(-3,1);
        Rational r_1_m3 = new Rational(1,-3);
    ...
    public void test_reciprocalOf_r_1_m3() {
        Rational r_1_m3 = new Rational(1, -3);
        assertEquals("-3", r_1_m3.reciprocalOf().toString());
    }

    @Test
    public void test_reciprocalOf_r_m30_m85() {
        Rational r_m30_m85 = new Rational(-30, -85);
        assertEquals("17/6", r_m30_m85.reciprocalOf().toString());
    }
    ...
    @Test
    public void test_r_13_4_dividedBy_r_3_7() {
        Rational r = r_13_4.dividedBy(r_3_7);
    ...
    @Test
    public void test_r_m3_11_dividedBy_3_8() {
        Rational r_m3_11 = new Rational(-3,11);
        Rational r_3_8 = new Rational(3,8);
        Rational r = r_m3_11.dividedBy(r_3_8);
        assertEquals("-8/11",r.toString());
    }
    ...
    @Test
    public void test_quotient_of_r_m3_1_and_r_1_m3() {
        Rational r_m3_1 = new Rational(-3,1);
        Rational r_1_m3 = new Rational(1,-3);
    ...
    @Test
    public void test_quotient_of_r_m3_11_and_r_3_8() {
        Rational r_m3_11 = new Rational(-3,11);
        Rational r_3_8 = new Rational(3,8);
        Rational r = Rational.quotient(r_m3_11,r_3_8);
        assertEquals("-8/11",r.toString());
    }
}